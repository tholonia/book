...
echo "    The baseurl is \033[1;32m/$BASEURL\033[00m"
echo "    The url is \033[1;32mhttps://YourGitHubUsername.github.io\033[00m"
echo "2. Run Jekyll for the first time on your computer:"
echo "    \033[1;32mbundle exec jekyll serve --livereload\033[00m"
...
echo "    Search for and select \033[1;32mPublish to GitHub\033[00m"
...
echo "    \033[1;32mhttps://YourGitHubUserName.github.io/$BASEURL\033[00m"
